...
int check_file_stat(struct ext2_inode*, ext2_ino_t); //check inode; return true if blocks not allocated and not recovered
int check_file_recover(struct ext2_inode*, ext2_ino_t); // return percentage of not allocated blocks
